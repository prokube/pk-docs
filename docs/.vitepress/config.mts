...
const versionSidebars = Object.fromEntries(
  visibleVersions.map((version) => [`/${version}/`, sidebarFor(version)])
)
...
export default defineVersionedConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Welcome', link: '/' },
      { text: 'Labs', link: `/${latestReleasedVersion}/labs/` },
      { text: 'AgentOps', link: `/${latestReleasedVersion}/agentops/` },
      { text: 'MLOps', link: `/${latestReleasedVersion}/mlops/` },
      { text: 'Foundation', link: `/${latestReleasedVersion}/platform/` },
      { text: 'Admin', link: `/${latestReleasedVersion}/admin/` },
      {
    ...
    sidebar: {
      ...versionSidebars,
      '/': sidebarFor(latestReleasedVersion)
    },
    footer: {
